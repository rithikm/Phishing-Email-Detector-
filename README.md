...
product is an interactive web application where the user pastes the email body text and receives a
classification on whether the email is Phishing or Legitimate.
